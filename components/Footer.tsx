      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-1 mb-4">
              <span className="font-bold text-2xl bg-gradient-to-r from-slate-700 to-blue-700 bg-clip-text text-transparent">
                Offshore
              </span>
            ...
            <p className="text-gray-600 mb-4 leading-relaxed">
              OffshoreFlowは、日本品質のオフショア開発サービスです。
              <br />
              スムーズな開発フローで、お客様のビジネスを加速します。
            </p>
            <div className="flex space-x-4">
              {[
                { icon: '📧', href: 'mailto:contact@offshoreflow.co.jp', label: 'メール' },
        ...
        <div className="border-t border-gray-300 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">
            &copy; {new Date().getFullYear()} OffshoreFlow株式会社. All rights reserved.
          </p>
